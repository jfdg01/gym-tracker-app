...
CREATE TABLE `__new_workout_logs` (
	...
	`program_id` integer,
	`day_id` integer,
	`completed_at` integer DEFAULT '"2025-12-03T10:22:24.059Z"',
...
ALTER TABLE `exercises` ADD `type` text DEFAULT 'reps';--> statement-breakpoint
ALTER TABLE `exercises` ADD `time_duration` integer;--> statement-breakpoint
ALTER TABLE `exercises` ADD `current_val_text` text;--> statement-breakpoint
ALTER TABLE `exercises` ADD `time_increase_step` integer DEFAULT 5;--> statement-breakpoint
ALTER TABLE `exercises` ADD `max_time_cap` integer DEFAULT 120;